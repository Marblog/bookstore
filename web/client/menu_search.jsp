...
<div id="divmenu">
    ...
    <a href="${pageContext.request.contextPath}/showProductByPage?category=文学" style="color:#FFFF00">全部商品目录</a>
</div>
<div id="divsearch">
        ...
        <table width="100%" border="0" cellspacing="0">
            <tr>
                <td style="text-align:right; padding-right:220px">
                    ...
                    <a href="#">
                        <img src="${pageContext.request.contextPath}/client/images/serchbutton.gif" border="0"
